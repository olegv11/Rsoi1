...
public class AuthController {
    ...
    public TokenPair GetToken(HttpServletRequest request, HttpServletResponse response) {
        String creds = request.getHeader("Authorization");
    ...
    public TokenPair RefreshToken(HttpServletRequest request, HttpServletResponse response, @RequestBody String refreshToken) {
        ...
        if (creds == null || !creds.startsWith("Bearer ")) {
            response.setStatus(HttpStatus.FORBIDDEN.value());
            return null;
        }
