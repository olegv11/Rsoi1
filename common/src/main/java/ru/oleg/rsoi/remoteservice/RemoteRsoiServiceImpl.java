...
public abstract class RemoteRsoiServiceImpl<Request, Response> implements RemoteRsoiService<Request, Response> {

    private final Class<Response> type;
    private final Class<Response[]> typeArray;

    public RemoteRsoiServiceImpl(Class<Response> responseClass, Class<Response[]> responseArrayClass) {
